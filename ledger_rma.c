...
typedef struct BCastCommunicator {
    ...
    int send_cnt;                       /* # of outstanding non-blocking sends */
    MPI_Request* isend_reqs;            /* Array for non-blocking send requests */
    MPI_Status* isend_stats;            /* Array for non-blocking send statuses */
